...
import { AlertTriangle, CheckCircle2, ClipboardPaste, Loader2, MapPin } from "lucide-react";
        ...
        {step === "code" && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Der Code steht auf dem Bildschirm des Telefons, das gerade mit
                dem Pi verbunden war. Sechs Zeichen, Großbuchstaben und
                Ziffern.
              </DialogDescription>
            </DialogHeader>
            ...
            <button
              ...
              onClick={async () => {
                ...
                const next = Array(6).fill("");
                for (let i = 0; i < 6 && i < clean.length; i++) next[i] = clean[i];
                setDigits(next);
                setCodeError(null);
              }}
              ...
              <div className="flex gap-2.5 rounded-lg border border-destructive/30 bg-destructive/10 p-3.5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[13px] leading-relaxed text-muted-foreground">
                    ...
                    taucht er hier noch nicht auf — dann zuerst das Setup am
                    Pi abschließen.
                  </p>
                </div>
              </div>
            ...
            <div className="flex justify-end gap-2">
              ...
              >
                {checkingCode ? "Prüfe …" : codeError ? "Erneut prüfen" : "Weiter"}
              </Button>
            </div>
          </>
        )}
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <p className="mt-2.5 flex gap-2 text-[12.5px] leading-relaxed text-muted-foreground">
                  ...
                  Der Standort bestimmt Sonnenauf- und -untergang und damit
                  das Aufnahmefenster des Pi.
                </p>
              </div>
            </div>
          ...
          <>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 max-w-[320px] text-[13.5px] leading-relaxed text-muted-foreground">
                Der Pi fragt jetzt jede Minute nach. Der erste Heartbeat kommt
                in spätestens fünf Minuten — dann erscheint das Volk in der
                Anlage-Liste.
              </p>
